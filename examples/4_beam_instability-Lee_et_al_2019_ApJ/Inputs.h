...
namespace Input {
    ...
    ///
    constexpr unsigned field_recording_frequency = 10;
    ...
    ///
    constexpr unsigned particle_recording_frequency = 50;

    /// maximum number of particles to dump
    ///
    constexpr std::array<unsigned, PtlDesc::Ns> Ndumps = {20000, 20000};
}
