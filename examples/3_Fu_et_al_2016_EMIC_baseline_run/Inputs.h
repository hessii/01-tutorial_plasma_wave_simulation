...
namespace Input {
    ...
    ///
    constexpr unsigned moment_recording_frequency = 4;

    /// frequency of simulation particle recordings
    ///
    constexpr unsigned particle_recording_frequency = 480;
    ...
    /// simulation time t = dt*Nt
    ///
    constexpr unsigned outer_Nt = 4800;
    ...
    namespace iKinetic {
        ...
        ///
        constexpr std::array<unsigned, Ns> Ncs = {24000, 24000, 24000};

        /// ion cyclotron frequencies for individual populations
        ///
        constexpr std::array<Real, Ns> Ocs = {1, 1, 1./4};
