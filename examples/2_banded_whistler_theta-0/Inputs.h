...
namespace Input {
    ...
    ///
    constexpr unsigned inner_Nt = 10;

    /// number of time steps for outer loop
    /// total time step Nt = inner_Nt * outer_Nt
    /// simulation time t = dt*Nt
    ///
    constexpr unsigned outer_Nt = 9000;
    ...
    ///
    constexpr unsigned field_recording_frequency = 50;
